    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-xl p-0 overflow-hidden">
        <div className="relative">
          <div className="h-20 w-full bg-gradient-to-r from-indigo-600/80 to-cyan-500/80" />
          <DialogClose asChild>
        ...
        <div className="px-6 pt-12 pb-6">
          ...
          <DialogFooter className="mt-6">
            <DialogClose asChild>
              <Button className="w-full bg-gradient-to-r from-indigo-500 to-cyan-500 text-white hover:opacity-90">Empezar</Button>
            </DialogClose>
          </DialogFooter>
        </div>
      </DialogContent>
